    ...
    mapper(0)
{
    ...
    ui->freeAtStartup->setToolTip(ui->freeAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->freeAtStartup->setText(ui->freeAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openFreeConfButton->setToolTip(ui->openFreeConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new FreeUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->freeAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openFreeConfButton_clicked()
{
