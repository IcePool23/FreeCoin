...
void WalletView::setFreeGUI(FreeGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? FreeGUI::HD44_ENABLED : _walletModel->hdEnabled() ? FreeGUI::HD_ENABLED : FreeGUI::HD_DISABLED);
