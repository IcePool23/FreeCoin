...
/* FreeGUI -- Size of icons in status bar */
...
/* Freecoin dark orange */
#define COLOR_DARK_ORANGE QColor("#f05239")
/* Freecoin light orange */
...
/* Freecoin shadow color - light mode */
...
/* Freecoin label color as a string */
...
#define QAPP_ORG_NAME "Free"
#define QAPP_ORG_DOMAIN "free.org"
#define QAPP_APP_NAME_DEFAULT "Free-Qt"
#define QAPP_APP_NAME_TESTNET "Free-Qt-testnet"

/* Default third party browser urls */
#define DEFAULT_THIRD_PARTY_BROWSERS "https://api.freecoin.org/tx/%s|https://rvn.cryptoscope.io/tx/?txid=%s|https://blockbook.freecoin.org/tx/%s|https://explorer.mangofarmassets.com/tx/%s|https://www.assetsexplorer.com/tx/%s|https://explorer.freeland.org/tx/%s"
