...
/** Free unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class FreeUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit FreeUnits(QObject *parent);
...
typedef FreeUnits::Unit FreeUnit;
