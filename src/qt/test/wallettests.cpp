...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<FreeAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_free-qt -platform xcb      # Linux
//     src/qt/test/test_free-qt -platform windows  # Windows
//     src/qt/test/test_free-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = FreeUnits::formatWithUnit(unit, balance, false, FreeUnits::separatorAlways);
    ...
    // Amount input
    FreeAmountField* amountInput = receiveCoinsDialog.findChild<FreeAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: free:")) != -1);
