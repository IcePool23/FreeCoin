...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(FreeUnits::RVN),
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(FreeUnits::formatWithUnit(unit, balance, false, FreeUnits::separatorAlways));
    ui->labelUnconfirmed->setText(FreeUnits::formatWithUnit(unit, unconfirmedBalance, false, FreeUnits::separatorAlways));
    ui->labelImmature->setText(FreeUnits::formatWithUnit(unit, immatureBalance, false, FreeUnits::separatorAlways));
    ui->labelTotal->setText(FreeUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, FreeUnits::separatorAlways));
    ui->labelWatchAvailable->setText(FreeUnits::formatWithUnit(unit, watchOnlyBalance, false, FreeUnits::separatorAlways));
    ui->labelWatchPending->setText(FreeUnits::formatWithUnit(unit, watchUnconfBalance, false, FreeUnits::separatorAlways));
    ui->labelWatchImmature->setText(FreeUnits::formatWithUnit(unit, watchImmatureBalance, false, FreeUnits::separatorAlways));
    ui->labelWatchTotal->setText(FreeUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, FreeUnits::separatorAlways));
