...
#include "config/free-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatFreeURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + FreeUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatFreeURI(info));
}
