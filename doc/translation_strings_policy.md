...
This document provides guidelines for internationalization of the Free Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `free_en.ts` remains unchanged.
