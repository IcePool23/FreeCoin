Free Core version *2.1.0* is now available!!
==============

  <https://github.com/FreeProject/Freecoin/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/FreeProject/Freecoin/commits/release_2.1.0>
