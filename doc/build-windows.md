...
Below are some notes on how to build Free Core for Windows.
...
way. This will install to `c:\workspace\free`, for example:

    make install DESTDIR=/mnt/c/workspace/free
