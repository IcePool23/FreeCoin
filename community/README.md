...
We’re all in this together. There are new capabilities included in the latest Phoenix version (3.2+) of Freecoin that open up new business opportunities.  Join in and build something.  This is not an exhaustive list, but just a starting point to fire the imagination.  
...
* Core
    * Asset Exchange Proxy (simulate sending an ASSET like freed does for RVN)
...
* Run a contest: RVN prize for best idea for new Freecoin based Business
...
* Back-end API platform for Freecoin
...
* #KYC tagger - store info and tag Freecoin addresses
* #ACCREDITED - verify accredited status and tag Freecoin addresses
 
### Technical Consultant
* Help companies apply Freecoin capabilities to real-world problems
* Security Token Issuance Platform
