...
import os
import struct
from test_framework.test_framework import FreeTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(FreeTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that free has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("freed has not been built with zmq enabled.")
