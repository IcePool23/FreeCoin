...
class TestFreeCli(FreeTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `free-cli getinfo`")
        ...
        self.log.info("Compare responses from `free-cli -getinfo` and the RPCs data is retrieved from.")
