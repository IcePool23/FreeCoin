...
By default, freed will dump mempool on shutdown and
...
class MempoolPersistTest(FreeTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give freed a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent freed from writing mempool.dat to disk. Verify that `savemempool` fails")
