...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the FreeTestFramework
    pass

class ExampleTest(FreeTestFramework):
    # Each functional test is a subclass of the FreeTestFramework class.
    ...
    def custom_method(self):
        ...
        FreeTestFramework class so other tests can use it."""
