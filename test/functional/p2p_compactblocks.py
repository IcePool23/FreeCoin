...
# TestNode: A peer we use to send messages to freed, and store responses.
...
class CompactBlocksTest(FreeTestFramework):
    ...
    # This test actually causes freed to (reasonably!) disconnect us, so do this last.
    ...
    # Test that freed requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for freed to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # freed will not send blocktxn responses for blocks whose height is
