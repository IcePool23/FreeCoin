...
class BIP66Test(FreeTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # freed is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and freed produces more specific reject
            # reasons.
