...
class AssetTest(FreeTestFramework):
    ...
    def big_test(self):
        ...
        free_assets = n0.listassets(asset="RAVEN*", verbose=False, count=2, start=-2)
        assert_equal(len(free_assets), 2)
        assert_equal(free_assets[0], "RAVEN2")
        assert_equal(free_assets[1], "RAVEN3")
        self.sync_all()
