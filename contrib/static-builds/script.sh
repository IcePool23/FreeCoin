...
find ${DISTNAME}/bin -type f -executable -exec ../freecoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../freecoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/freecoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/freecoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
