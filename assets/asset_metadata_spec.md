## Freecoin Metadata Specification

Additional fields may be added, but will be ignored by Freecoin.
...
```
{
   ...
   "contract_signature": "<Freecoin signed contract_hash>",
